...
import com.br.desafionekiapi.core.security.AuthEntryPointJwt;
import com.br.desafionekiapi.core.security.AuthTokenFilter;
import com.br.desafionekiapi.core.security.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(login -> login
            		.requestMatchers("/login/**", "/swagger-ui/**", "/v3/api-docs/**").permitAll() //define as rotas publicas/abertas
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "192.168.0.104"));
